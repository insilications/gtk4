...
Source0  : https://download.gnome.org/sources/gtk/4.4/gtk-4.4.1.tar.xz
...
%prep
%setup -q -n gtk-4.4.1
cd %{_builddir}/gtk-4.4.1
pushd ..
cp -a gtk-4.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635809391
...
cp %{_builddir}/gtk-4.4.1/COPYING %{buildroot}/usr/share/package-licenses/gtk4/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/gtk-4.4.1/gdk/COPYING %{buildroot}/usr/share/package-licenses/gtk4/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/gtk-4.4.1/gtk/roaring/COPYING %{buildroot}/usr/share/package-licenses/gtk4/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gtk-4.4.1/gtk/timsort/COPYING %{buildroot}/usr/share/package-licenses/gtk4/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gtk-4.4.1/subprojects/gi-docgen/LICENSES/Apache-2.0.txt %{buildroot}/usr/share/package-licenses/gtk4/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gtk-4.4.1/subprojects/gi-docgen/LICENSES/CC-BY-SA-3.0.txt %{buildroot}/usr/share/package-licenses/gtk4/fb41626a3005c2b6e14b8b3f5d9d0b19b5faaa51
cp %{_builddir}/gtk-4.4.1/subprojects/gi-docgen/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/gtk4/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/gtk-4.4.1/subprojects/gi-docgen/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/gtk4/31a3d460bb3c7d98845187c716a30db81c44b615
cp %{_builddir}/gtk-4.4.1/subprojects/gi-docgen/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/gtk4/220906dfcc3d3b7f4e18cf8a22454c628ca0ea2e
cp %{_builddir}/gtk-4.4.1/subprojects/gi-docgen/LICENSES/OFL-1.1.txt %{buildroot}/usr/share/package-licenses/gtk4/8b8a351a8476e37a2c4d398eb1e6c8403f487ea4
